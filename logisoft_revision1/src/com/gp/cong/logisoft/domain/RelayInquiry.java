 ...
 *
 */
public class RelayInquiry implements Auditable, Serializable {
    ...
    private Set destinationSet;
    private Set portExceptionSet;
    ...
    public void setDestinationSet(Set destinationSet) {
    ...
    public Set getPortExceptionSet() {
        return portExceptionSet;
    }

    public void setPortExceptionSet(Set portExceptionSet) {
        this.portExceptionSet = portExceptionSet;
    }
