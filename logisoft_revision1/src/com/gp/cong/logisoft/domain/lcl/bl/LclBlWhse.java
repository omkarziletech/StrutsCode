 ...
 */
@Entity
@Table(name = "lcl_bl_whse")
public class LclBlWhse extends Domain {
    ...
    public LclBlWhse(Long id) {
        this.id = id;
    }

    public LclBlWhse(Long id, boolean overShortDamaged, Date enteredDatetime, Date modifiedDatetime) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof LclBlWhse)) {
            return false;
        }
        LclBlWhse other = (LclBlWhse) object;
    ...
    public String toString() {
        return "com.gp.cong.logisoft.domain.lcl.bl.LclBlWhse[id=" + id + "]";
    }
}
