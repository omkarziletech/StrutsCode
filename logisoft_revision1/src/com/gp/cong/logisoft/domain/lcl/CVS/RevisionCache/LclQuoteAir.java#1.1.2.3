 ...
 */
@Entity
@Table(name = "lcl_quote_air")
@DynamicInsert(true)
@DynamicUpdate(true)
public class LclQuoteAir extends Domain {
    ...
    public LclQuoteAir(Long fileNumberId) {
        this.fileNumberId = fileNumberId;
    }

    public LclQuoteAir(Long fileNumberId, String serviceType) {
        this.fileNumberId = fileNumberId;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof LclQuoteAir)) {
            return false;
        }
        LclQuoteAir other = (LclQuoteAir) object;
    ...
    public String toString() {
        return "com.gp.cong.logisoft.domain.lcl.LclQuoteAir[fileNumberId=" + fileNumberId + "]";
    }
}
