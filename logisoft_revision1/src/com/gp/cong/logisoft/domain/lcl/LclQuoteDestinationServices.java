...
@Entity
@Table(name = "lcl_quote_dstsvc")
@DynamicInsert(true)
@DynamicUpdate(true)
public class LclQuoteDestinationServices extends Domain {
    ...
    public LclQuoteDestinationServices() {
    }

    public LclQuoteDestinationServices(Long id) {
        this.id = id;
    }

    public LclQuoteDestinationServices(Long id, String city, String country, int oncarriageTt, int oncarriageTtFreq, Date enteredDatetime, Date modifiedDatetime) {
        this.id = id;
        this.city = city;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof LclQuoteDestinationServices)) {
            return false;
        }
        LclQuoteDestinationServices other = (LclQuoteDestinationServices) object;
    ...
    public String toString() {
        return "com.gp.cong.logisoft.domain.lcl.LclQuoteDestinationServices[ id=" + id + " ]";
    }
