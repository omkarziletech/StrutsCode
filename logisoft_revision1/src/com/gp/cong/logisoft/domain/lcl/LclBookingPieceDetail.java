 ...
 */
@Entity
@Table(name = "lcl_booking_piece_detail")
@DynamicInsert(true)
@DynamicUpdate(true)
public class LclBookingPieceDetail extends Domain {
    ...
    public LclBookingPieceDetail() {
    }

    public LclBookingPieceDetail(Long id) {
        this.id = id;
    }

    public LclBookingPieceDetail(Long id, int pieceCount, String actualUom, Date enteredDatetime, Date modifiedDatetime) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof LclBookingPieceDetail)) {
            return false;
        }
        LclBookingPieceDetail other = (LclBookingPieceDetail) object;
    ...
    public String toString() {
        return "com.gp.cong.logisoft.domain.lcl.LclBookingPieceDetail[id=" + id + "]";
    }
}
