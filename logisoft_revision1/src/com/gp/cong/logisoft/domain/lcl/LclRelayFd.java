 ...
 */
@Entity
@Table(name = "lcl_relay_fd")
public class LclRelayFd extends Domain {
    ...
    public LclRelayFd(Long id) {
        this.id = id;
    }

    public LclRelayFd(Long id, boolean active, int transitTime, Date enteredDatetime, Date modifiedDatetime) {
        this.id = id;
        this.active = active;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof LclRelayFd)) {
            return false;
        }
        LclRelayFd other = (LclRelayFd) object;
    ...
    public String toString() {
        return "com.gp.cong.logisoft.domain.lcl.LclRelayFd[id=" + id + "]";
    }
}
