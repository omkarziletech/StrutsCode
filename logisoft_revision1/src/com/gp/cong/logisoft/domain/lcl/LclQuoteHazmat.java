 ...
 */
@Entity
@Table(name = "lcl_quote_hazmat")
@DynamicInsert(true)
@DynamicUpdate(true)
public class LclQuoteHazmat extends Domain {
    ...
    public LclQuoteHazmat() {
    }

    public LclQuoteHazmat(Long id) {
        this.id = id;
    }

    public LclQuoteHazmat(Long id, String unHazmatNo, String properShippingName, String technicalName, Date enteredDatetime, Date modifiedDatetime) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof LclQuoteHazmat)) {
            return false;
        }
        LclQuoteHazmat other = (LclQuoteHazmat) object;
    ...
    public String toString() {
        return "com.gp.cong.logisoft.domain.lcl.LclQuoteHazmat[id=" + id + "]";
    }
}
