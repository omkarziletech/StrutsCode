 ...
 */
@Entity
@Table(name = "lcl_quote_whse")
@DynamicInsert(true)
@DynamicUpdate(true)
public class LclQuoteWhse extends Domain {
    ...
    public LclQuoteWhse(Long id) {
        this.id = id;
    }

    public LclQuoteWhse(Long id, boolean overShortDamaged, Date enteredDatetime, Date modifiedDatetime) {
        this.id = id;
    ...
    public User getStowedBy() {
        return stowedBy;
    }

    public void setStowedBy(User stowedBy) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof LclQuoteWhse)) {
            return false;
        }
        LclQuoteWhse other = (LclQuoteWhse) object;
    ...
    public String toString() {
        return "com.gp.cong.logisoft.domain.lcl.LclQuoteWhse[id=" + id + "]";
    }
