 ...
 */
@Entity
@Table(name = "lcl_bl_plan")
public class LclBlPlan extends Domain {
    ...
    public LclBlPlan(LclFileNumber lclFileNumber) {
        this.lclFileNumber = lclFileNumber;
    }

    public LclBlPlan(Long id) {
        this.id = id;
    }

    public LclBlPlan(Long id, Integer segNo, boolean relayOverride, Date enteredDatetime, Date modifiedDatetime) {
        this.id = id;
        this.segNo = segNo;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof LclBlPlan)) {
            return false;
        }
        LclBlPlan other = (LclBlPlan) object;
    ...
    public String toString() {
        return "com.gp.cong.logisoft.domain.lcl.bl.LclBlPlan[id=" + id + "]";
    }
}
