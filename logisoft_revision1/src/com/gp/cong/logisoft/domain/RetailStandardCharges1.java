...
public class RetailStandardCharges1 implements Auditable,Serializable {
	private static final long serialVersionUID = 1L;
	
	private Integer standardId;
	private Integer retailStdId;
	...
	private RefTerminal origin;
	private Ports destination;
	private Integer id;
	...
	public Integer getRetailStdId() {
		return retailStdId;
	}
	public void setRetailStdId(Integer retailStdId) {
		this.retailStdId = retailStdId;
	}
	...
	public Ports getDestination() {
		return destination;
	}
	public void setDestination(Ports destination) {
		this.destination = destination;
	}
	public RefTerminal getOrigin() {
		return origin;
	}
	public void setOrigin(RefTerminal origin) {
		this.origin = origin;
	}
