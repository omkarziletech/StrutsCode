...
public class LoadRecords {
    ...
    public void getExcelRecords(List records, int sheetNo, int j)throws Exception {
        ...
        if (org != null && !org.equals("")) {
            ...
            List unLocationList = refTerminalDAO.findForManagement(org, null);
        ...
        if (dest != null && !dest.equals("")) {
            ...
            List portsList = portsDAO.findForManagement(port, null);
                    ...
                    if (cellValues.length > 2 && cellValues[2] != null && !cellValues[2].trim().equals("")) {
                        ...
                        if (!found) {
                            ...
                            if (contentType == null || contentType.equals("")) {
                                genObj = genericCodeDAO.findByCodeName("I", 37);//11460 PRIMARY FREIGHT //11516 BAL SHIPPING  // SEACORP 11460 Per Container size
                            } else if (contentType != null && contentType.equals("%")) {
                                genObj = genericCodeDAO.findByCodeName("PER", 37);//SEACOPR 11516 PER CANTAGE OFR
                            } else if (contentType != null && contentType.equals("*")) {
                                genObj = genericCodeDAO.findByCodeName("H", 37);//SEACOPR 11516//PER BL
                            } else if (contentType != null && contentType.equals("#")) {
                                genObj = genericCodeDAO.findByCodeName("K", 37);
                            } else {
                                genObj = genericCodeDAO.findByCodeName("A", 37);
                            }
