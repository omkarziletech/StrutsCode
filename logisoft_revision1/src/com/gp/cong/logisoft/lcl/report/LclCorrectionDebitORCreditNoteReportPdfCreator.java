...
public class LclCorrectionDebitORCreditNoteReportPdfCreator extends ReportFormatMethods {
   ...
   public void initialize(String fileName) throws FileNotFoundException,
    ...
    public void createBody(LCLCorrectionNoticeBean lclCorrectionNoticeBean,String contextPath,HttpServletRequest request)
    	...
    	Font palatinoRomanBoldFont = new Font(palationRomanBase,8, Font.BOLD, Color.BLACK);
        ...
        celL.addElement(new Chunk(img, 192, -5));
        celL.setBorder(0);
        ...
        headingTable.setWidths(new float[]{12,28,42,8,10});
        ...
        headingTable.addCell( makeCellLeftNoBorderFclBL(""));
        headingTable.addCell(makeCellLeftNoBorderPalatinoFclBl("",palatinoRomanSmallFont));
        celL=  makeCellleftNoBorderForHeadingWithRedFont(lclCorrectionNoticeBean.getDebitOrCreditNote());
        headingTable.addCell(celL);
        ...
        destinationOriginTable.addCell(makeCellRightNoBorderFclBL("To Party :"));
        destinationOriginTable.addCell(makeCellLeftNoBorderPalatinoFclBl(lclCorrectionNoticeBean.getCustomer(),palatinoRomanSmallFont));
        ...
        destinationOriginTable.addCell(makeCellRightNoBorderFclBL(""));
        destinationOriginTable.addCell(makeCellLeftNoBorderPalatinoFclBl(lclCorrectionNoticeBean.getBillToPartyAddress(),palatinoRomanSmallFont));
        ...
        destinationOriginTable.addCell(makeCellRightNoBorderFclBL(type + " Note Date :"));
        ...
        destinationOriginTable.addCell(makeCellRightNoBorderFclBL(""));
        destinationOriginTable.addCell(makeCellLeftNoBorderPalatinoFclBl("",palatinoRomanSmallFont));
        ...
        detailsTable.addCell(makeCellRightNoBorderFclBL(type + " Note Number :"));
        detailsTable.addCell(makeCellLeftNoBorderPalatinoFclBl(lclCorrectionNoticeBean.getBlNo()+"CN"+lclCorrectionNoticeBean.getCorrectionNo(),palatinoRomanSmallFont));
        ...
        //detailsTable.addCell(makeCellLeftNoBorderPalatinoFclBl("",palatinoRomanSmallFont));
        ...
        chargesTable.setWidths(new float[]{10,25,20,20,17,8});
        chargesTable.addCell(makeCellLeftNoBorderFclBLUnderLined("Code"));
        chargesTable.addCell(makeCellRightNoBorderFclBLUnderLined("Description"));
         chargesTable.addCell(makeCellRightNoBorderFclBLUnderLined("Amount"));
        chargesTable.addCell(makeCellRightNoBorderFclBLUnderLined(""));
        chargesTable.addCell(makeCellRightNoBorderFclBLUnderLined(""));
        chargesTable.addCell(makeCellRightNoBorderFclBLUnderLined(""));
        cell= makeCellleftNoBorder("");
        cell.setColspan(6);
       ...
       for (LCLCorrectionChargeBean lclCorrectionChargeBean:lclCorrectionChargesList) {
        	...
        	chargesTable.addCell(makeCellRightNoBorderPalatinoFclBl(lclCorrectionChargeBean.getChargeDescriptions(),palatinoRomanSmallFont));
        	if(lclCorrectionNoticeBean.getStrCorrectionType().equalsIgnoreCase("A") || lclCorrectionNoticeBean.getStrCorrectionType().equalsIgnoreCase("Y")){
              	if(lclCorrectionNoticeBean.getDebitOrCreditNote().equals(FclBlConstants.CREDTINOTE)){
              		debitOrCredit="CREDIT";
              	}else{
              		debitOrCredit="DEBIT";
              	}
                if (lclCorrectionChargeBean.getDifferenceAmount()!=null) {
                    differenceAmount  = lclCorrectionChargeBean.getDifferenceAmount().doubleValue();
                }
                if (lclCorrectionChargeBean.getNewAmount()!=null && lclCorrectionChargeBean.getNewAmount().doubleValue()>0.00) {
                    newAmountTotal += lclCorrectionChargeBean.getNewAmount().doubleValue();
                    oldAmountTotal += lclCorrectionChargeBean.getOldAmount().doubleValue();
                }
        	}else{
        	}
                chargesTable.addCell(makeCellRightNoBorderPalatinoFclBl("USD " +numberFormat.format(differenceAmount) ,palatinoRomanSmallFont));
        ...
        cell= makeCellRightNoBorderPalatinoFclBl("Total",palatinoRomanBoldFont);
        chargesTable.addCell(cell);
        
        if(lclCorrectionNoticeBean.getStrCorrectionType().equalsIgnoreCase("A") || lclCorrectionNoticeBean.getStrCorrectionType().equalsIgnoreCase("Y")){
            cell= makeCellRightNoBorderPalatinoFclBl("USD " +numberFormat.format(newAmountTotal-oldAmountTotal),palatinoRomanBoldFont);
            chargesTable.addCell(cell);
            chargesTable.addCell(makeCellLeftNoBorderPalatinoFclBl("(" + debitOrCredit + ")", palatinoRomanSmallFont));
	    chargesTable.addCell(makeCellLeftNoBorderPalatinoFclBl("", palatinoRomanSmallFont));
	    chargesTable.addCell(makeCellLeftNoBorderPalatinoFclBl("", palatinoRomanSmallFont));
    ...
    public String createLclCorrectionsReport(LCLCorrectionNoticeBean lclCorrectionNoticeBean,String fileName,
            ...
            this.createBody(lclCorrectionNoticeBean,contextPath,request);
            this.destroy();
        return "fileName";
    }
}
