...
public class RelayDestinationDAO extends BaseHibernateDAO {

    /**
     * Method for Saving Warehouses
     * @param transientInstance
     */
    public void save(RelayDestination transientInstance) throws Exception {
     ...
     */
    public RelayDestination findById(String id) throws Exception {
        RelayDestination instance = (RelayDestination) getCurrentSession().get("com.gp.cong.logisoft.domain.RelayDestination", id);
        return instance;
    }
    ...
    public Integer getNumberOFDestinations(Integer relayId) throws Exception {
        ...
        String queryString = "select count(*) from RelayDestination where relayId=?0";
        Query queryObject = getCurrentSession().createQuery(queryString);
