...
public class RelayOriginDAO extends BaseHibernateDAO {
     ...
     */
    public void save(RelayOrigin transientInstance) throws Exception {
    ...
    public Integer getNumberOFOrigins(Integer relayId)throws Exception {
        Iterator results = null;
            String queryString = "select count(*) from RelayOrigin where relayId=?0";
            Query queryObject = getCurrentSession().createQuery(queryString);
