...
import com.gp.cong.logisoft.domain.UnitCost;
import com.gp.cong.logisoft.domain.VoyageExport;

public class UnitCostDAO extends BaseHibernateDAO {
    ...
    public void save(UnitCost transientInstance) throws Exception {
