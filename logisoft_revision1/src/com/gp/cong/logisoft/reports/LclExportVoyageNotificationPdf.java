 ...
 * @author PALRAJ
 */
public class LclExportVoyageNotificationPdf implements LclCommonConstant, LclReportConstants {
    ...
    public void createPdf(String realPath, String outputFileName,
            Long notificationId, String companyName,
    ...
    public PdfPTable informationBlock(String companyName, String portofDischarge,
            String finalDestination) throws IOException, BadElementException, DocumentException {
        table = new PdfPTable(1);
        table.setWidthPercentage(100f);
