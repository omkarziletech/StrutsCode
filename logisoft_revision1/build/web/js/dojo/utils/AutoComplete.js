...
utils.AutoComplete = function() {
    ...
    this.postCreate = function() {
        ...
        dojo.event.connect(this.textbox, "onblur", this, "textboxOnBlur");
    }
    ...
    this.textboxOnKeyPress = function(evt) {
     ...
     this.textboxOnBlur = function(evt) {
    	if(this.actionCalled==false){
    ...
    this.setSelected = function(oldIndex, newIndex) {
        ...
        if (children) {
            ...
            if(this.textbox.value.indexOf('&amp;')!=-1){
	      	...
	      	if(this.textbox.value.indexOf(':-')!=-1){
	      	     if(this.textbox.value == "Freeport; Grand Bahama / BSFPO"){
	      	     	this.textbox.value = "Freeport; Grand Bahama / BSFPO";
	      	     }else{
	      		 	this.textbox.value = this.textbox.value.substring(0,this.textbox.value.indexOf(':-'));
	      		 }
	      	}
