...
String customerDetailsPath=path+"/jsps/Tradingpartnermaintainance/masterEditCustom.jsp";
String customerTabDetailsPath=path+"/jsps/MasterEditCustomerTabs.jsp";
%>
