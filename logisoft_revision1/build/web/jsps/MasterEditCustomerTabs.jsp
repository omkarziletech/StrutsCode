...
String customerDetailsPath=path+"/jsps/Tradingpartnermaintainance/masterEditGeneralInformation.jsp";
String customerAccount=path+"/jsps/Tradingpartnermaintainance/masterEditAccounting.jsp";
String customerconfig=path+"/jsps/Tradingpartnermaintainance/ContactConfig.jsp";
String accountDetailsPath=path+"/jsps/Tradingpartnermaintainance/masterEditCustomer.jsp";
String vendorpath=path+"/jsps/Tradingpartnermaintainance/MasterEditVendor.jsp";
%>
...
.dojoTabPaneWrapper {
 ...
 <body marginwidth="0" marginheight="0"  bgcolor="#E6F2FF">
  ...
  <div id="tab1"  dojoType="ContentPane" style="font-family:Arial;" label="Addresses" >
	  <iframe src="<%= accountDetailsPath%>"  width="100%" height="100%" frameborder="0" name="geniframe" id="geniframe"> </iframe>
	</div>
<div id="tab2"  dojoType="ContentPane" style="font-family:Arial;" label="General Info" >
	...
	<div id="tab3"  dojoType="ContentPane" style="font-family:Arial;" label="AR Config" >
	  ...
	  <div id="tab4"  dojoType="ContentPane" style="font-family:Arial;" label="AP Config" >
		  <iframe src="<%=vendorpath%>" width="100%" height="100%" frameborder="0" name="editvendiframe" id="editvendiframe"> </iframe>
		</div>
