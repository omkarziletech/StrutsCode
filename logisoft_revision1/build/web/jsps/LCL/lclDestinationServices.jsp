    ...
    <cong:form name="lclCostAndChargeForm" id="lclCostAndChargeForm" action="/lclCostAndCharge.do">
        ...
        <table border="0" width="100%">
            <tr>
                ...
                <td>
                    <html:select property="chargesCode" styleId="chargesCode" style="width:120px;"
        ...
        <table border="0" width="100%">
            <tr>
                ...
                <td id="costMeasure">
                    ...
                    <td id="costMinimum">
                    <cong:text name="minimumForCost" styleClass="textlabelsBoldForTextBox twoDigitDecFormat wmrate" 
                        ...
                        <tr>
                            ...
                            <td>
                                <cong:autocompletor  name="thirdPartyname" styleClass="textlabelsBoldForTextBox vendor" 
                                                     ...
                                                     template="tradingPartner" scrollHeight="300px" value="${lclCostAndChargeForm.thirdPartyname}"/>
                        ...
                        <tr>
                            ...
                            <td  id="manualCity">
                                <cong:text styleClass="mandatory text textuppercaseLetter city" 
                                           container="NULL" maxlength="25" name="manualCityName" id="manualcityName"/>
                            </td>
                            <td id="autoCompletorCity">
                                <cong:autocompletor id="cityName" name="cityName" template="one" fields="portname" 
                                                    ...
                                                    value="${lclCostAndChargeForm.cityName}"/>
                            </td>
                            <td>
                    ...
                    <table border="0">
                        ...
                        <tr>
                            ...
                            <td width="20%" class="frequency" style="padding-top:.7em;">
                                <html:select property="destFrequency" styleId="destFrequency" 
                                             value="${lclCostAndChargeForm.destFrequency}" style="width:110px;"
                        ...
                        <tr>
                            ...
                            <td class="totalDestTT" style="padding-top:.7em;">
                                <cong:text name="totalDestTT" id="totalDestTT" styleClass="bold mandatory" 
                                           style="width:108px" container="null" maxlength="3" 
                                           value="${lclCostAndChargeForm.totalDestTT}"/>
                            </td>
                        </tr>
                    </table>
                </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <html:textarea cols="20" rows="10" styleId="destinatnSersRemark" 
                                               ...
                                               value="${lclCostAndChargeForm.destinatnSersRemark}"/>
                            </td>
                        </tr>
                    </table>
                    <table class="agent">
                        <tr>
                            <td id="alterAgent" width="32%" class="textlabelsBoldforlcl">
                                ...
                                <cong:autocompletor  name="alternateAgent"  styleClass="agent mandatory" id="alternateAgent"  readOnly="" 
                                                     ...
                                                     query="AGENT"  params="E" template="tradingPartner"  scrollHeight="160px" value="${lclCostAndChargeForm.alternateAgent}"/>
                                <cong:hidden name="alternateAgentAccntNo" id="alternateAgentAccntNo" 
                                             value="${lclCostAndChargeForm.alternateAgentAccntNo}"/>
        ...
        <table class="display-table" id="destchargeTable">
            <thead>
            <th>Charge Code</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        setOptionForRate();
        setCityCountryName();
        if ($('#buttonValue').val() == 'editService') {
    ...
    function saveCodeDs(button) {
        ...
        if (chargesCode === 'Select One') {
            ...
            flag = false;
        } else if (!validateCostGLAccount(chargesCode)) {
            flag = false;
        ...
        if ($('#manualEntry').val() === 'true' && flag === true) {
            $.ajaxx({
                ...
                success: function (data) {
                    if (data == true) {
                        submitAjaxForm('addManualChargesForExport', '#lclCostAndChargeForm', '#chargeDesc', button);
                    } else {
                        if (thirdPartyname != "") {
                            submitAjaxForm('addManualChargesForExport', '#lclCostAndChargeForm', '#chargeDesc', button);
                        } else {
    ...
    function submitAjaxForm(methodName, formName, selector, button) {
        showLoading();
        var billToParty = parent.$("input:radio[name='billForm']:checked").val();
        billToParty = billToParty !== undefined ? billToParty : 'F';
        var chargeCode = $("#chargesCode option:selected").val();
        ...
        params += "&moduleName=" + moduleName + "&billToParty=" + billToParty + "&chargesCode=" + chargeCode;
        params += "&isDest_Service_Page=true&calculateMinMax=" + $("#overrideCalculator").is(":checked");
    ...
    function displayDestinationServices(path, chargeId, fileNumberId, fileNumber, buttonValue) {
        ...
        var href = path + "/lclCostAndCharge.do?methodName=displayDestinationServices&buttonValue=" + buttonValue
                + "&fileNumberId=" + fileNumberId + "&fileNumber=" + fileNumber + "&destination=" + fd
                + "&id=" + chargeId + "&manualEntry=true";
        ...
        $.prompt(txt, {
            ...
            submit: function (v) {
                if (v === 1) {
                    ...
                    var fd = parent.$('#unlocationCode').val();
                    var href = '${path}' + "/lclCostAndCharge.do?methodName=displayDestinationServices&buttonValue=" + buttonValue
                            + "&fileNumberId=" + fileNumberId + "&destination=" + fd + "&id=" + chargesCodeId + "&manualEntry=true";
                    document.location.href = href;
                } else if (v === 2) {
                    $.prompt.close();
                }
    ...
    function makeChargeFieldsReadOnly() {
        ...
        if ((blUnitCob == 'true' || fileNumberStatus == 'M') && voyageClosedBy == '') {
            ...
            $('#chargesCode').addClass('text-readonly');
            $('#chargesCode').attr('readonly', true);
            $('#chargesCode').attr('disabled', true);
            $('#chargesCode').attr('tabindex', -1);
            $('#costCalc').hide();
            $('#overrideCalculator').attr('disabled', true);
    ...
    function validateCostGLAccount(chargecode) {
        var flag = true;
