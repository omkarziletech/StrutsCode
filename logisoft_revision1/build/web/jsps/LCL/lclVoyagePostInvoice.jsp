    ...
    <cong:table styleClass="tableBorderNew" cellpadding="3" cellspacing="0"  width="100%">
        ...
        <cong:tr>
            ...
            <cong:td align="center">
                <span class="button-style1" style="margin-right: 20px" id="send" onclick="sendMail('postArRedInvoice');" >Send</span>
...
<script type="text/javascript">
    function sendMail(methodName){
        ...
        parent.$("#pageName").val('postArRedInvoice');
        parent.$("#lclVoyageArInvoiceForm").submit();
        parent.$.colorbox.close();
    }
    function backToInvoiceList(path,fileId,fileNumber,listFlag){
        var url=path+"/lclVoyageArInvoice.do?methodName=display&fileNumberId="+fileId+"&fileNumber="+fileNumber+"&listFlag="+listFlag;
        window.location=url;
    }
