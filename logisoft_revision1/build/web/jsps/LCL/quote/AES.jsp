...
<script type="text/javascript">
    ...
    function setColor() {
        if ($('#aestable tr').length > 2) {
            parent.$('#Qaes').addClass("green-background");
            parent.$('#aesQ').addClass("green-background");
        } else {
            parent.$('#aesQ').removeClass("green-background");
            parent.$('#Qaes').removeClass("green-background");
            parent.$('#aesQ').addClass("button-style1");
            parent.$('#Qaes').addClass("button-style1");
        }
    }
    function deleteAes(txt,lcl3pRefId) {
        $.prompt(txt, {
            buttons: {
                Yes: 1,
                No: 2
...
<body onload="setColor()">
    <cong:form name="lclQuoteForm" id="lclQuoteForm" action="lclQuote.do">
        <cong:hidden name="fileNumberId" value="${lclQuoteForm.fileNumberId}"/>
        <cong:hidden name="fileNumber" value="${lclQuoteForm.fileNumber}"/>
        <cong:table style="width:100%">
            <cong:tr styleClass="tableHeadingNew" >
                <cong:td width="90%">AES/ITN Add/View Details: <span class="fileNo">${lclQuoteForm.fileNumber}</span></cong:td>
                <cong:td><cong:div styleClass="button-style1" style="float:left"
                                   onclick="checkAESFlag();">Save</cong:div> </cong:td>
            </cong:tr>
                ...
                <cong:tr styleClass="textlabels">
                    ...
                    <cong:td valign="middle" width="30%">
                        <html:textarea property="aesItnNumber" styleClass="textlabelsBoldForTextBox" name="aesItnNumber" styleId="aesItnNumber"
                                       cols="45" rows="1" value="" onkeypress="return checkTextAreaLimit(this, 25)"  style="text-transform: uppercase;resize:none"/>
                    </cong:td>
                    <cong:td styleClass="textlabelsBoldleftforlcl" valign="middle" width="6%">Exception</cong:td>
                    <cong:td valign="middle" width="25%">
                        <html:textarea property="aesException"
                                       onkeypress="return checkTextAreaLimit(this, 50)"  styleClass="textlabelsBoldForTextBox" name="aesException" styleId="aesException"
                                       cols="70" rows="1" value="" style="text-transform: uppercase;resize:none"/>
                    </cong:td>
            ...
            <cong:tr>
                <cong:td>
                    <table width="100%" border="1" style="border-collapse: collapse; border: 1px solid #dcdcdc" id="aestable">
                                ...
                                <tr class="${zebra}" style="text-transform: uppercase">
                                    ...
                                    <td>
                                        <img src="${path}/img/icons/trash.jpg" alt="delete" height="12px" width="12px"
                                             onclick="deleteAes('Are you sure you want to delete?', '${aes.id}');" style="cursor: pointer"/>
                                    </td>
                                </tr>
                            </c:if>
                        </c:forEach>
            ...
            <cong:hidden name="noteId" id="noteId"/>
