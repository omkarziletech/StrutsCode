<%-- 
    Document   : spotRate
    Created on : Nov 20, 2012, 2:49:45 PM
    Author     : SathiyaPriya
--%>
...
<body style="background:#ffffff">
    <cong:div style="width:100%; float:left; ">
        <cong:form name="lclCostAndChargeForm" id="lclCostAndChargeForm" action="/lclCostAndCharge.do">
            <cong:hidden name="lclBookingAc.id" value="${lclBookingAc.id}"/>
            ...
            <table width="100%" border="0" cellpadding="1" cellspacing="1" class="tableBorderNew" align="center">
                <tr class="tableHeadingNew"><td>Spot Rate <span class="fileNo">${fileNumber}</span></td></tr>
                <tr><td><br/></td></tr>
                <tr><td>
                        <cong:table width="100%" border="0">
                            <cong:tr>
                                <cong:td styleClass="textBoldforlcl" colspan="2" width="20%">Rate
                            ...
                            <cong:tr>
                                <cong:td colspan="2">
                                    <cong:textarea rows="4" cols="30" name="comment" id="comment"
                                                   styleClass="textLCLuppercase" style="width:259px;resize:none" value="${comment}" >
                            ...
                            <cong:tr>
                                <cong:td colspan="2" styleClass="textBoldforlcl">
                                    ...
                                    <cong:checkbox name="spotCheckOF" id="spotCheckOF"
                                                   onclick="checkOcnFrt();" container="NULL" >
                                        or an Ocean Freight only spot rate?</cong:checkbox>
                                </cong:td>
                            </cong:tr>
                            <cong:tr>
                                <cong:td>
                                </cong:td>
                                <cong:td align="left" style="color: #FF0000;" width="52%" styleClass="textBoldforlcl">
...
<script type="text/javascript">
    ...
    function spotValidate() {
        ...
        else if (datatableobj >= 1 && parent.$('#spotRateCommNo').val() != parent.$('#comno').val()) {
            $("#updateTariff").val('Y');
            showAlert("Tariff Number Will Be Changed to <span style=color:red>212600</span> and rates will be recalculated.");
        } else {
            submitAjaxForm('addSpotRate', '#lclCostAndChargeForm', '#chargeDesc');
        }
    }
