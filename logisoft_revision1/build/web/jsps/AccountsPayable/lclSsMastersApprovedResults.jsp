            ...
            <div class="scrolldisplaytable">
                <table width="100%" cellpadding="0" cellspacing="3" class="displaytagstyleNew" id="ssMasters" style="border: 1px solid white">
                    <thead>
                        ...
                        <tr>
                            <th><a href="javascript:doSort('header.schedule_no','${orderBy}')"> Module Name </a></th>
                            <th><a href="javascript:doSort('header.schedule_no','${orderBy}')"> Voyage No </a></th>
                            <th><a href="javascript:doSort('tp.acct_name','${orderBy}')"> SSL Name </a></th>
                            <th><a href="javascript:doSort('tp.acct_no','${orderBy}')"> SSL No </a></th>
                            <th><a href="javascript:doSort('agent.acct_name','${orderBy}')"> Destination Agent Name </a></th>
                            <th><a href="javascript:doSort('agent.acct_no','${orderBy}')"> Destination Agent No </a></th>
                            <th><a href="javascript:doSort('etd','${orderBy}')"> ETD </a></th>
                            <th><a href="javascript:doSort('eta','${orderBy}')"> ETA </a></th>
                            <th><a href="javascript:doSort('ss.prepaid_collect','${orderBy}')"> Prepaid/Collect </a></th>
                            <th>Action</th>
                        </tr>
                    </thead>
                    <tbody>
                            ...
                            <tr class="${zebra}">
                                ...
                                <td>
                                    <img alt="Convert to AP" title="Convert to AP"
                                         src="${path}/images/icons/forward.png" onclick="convertLclSsMasterToAp('${ssMasters.headerId}','${ssMasters.bookingNumber}','${ssMasters.sslineNo}','${ssMasters.fileNo}','${ssMasters.etd}','SSMastersLcl','${ssMasters.ssMasterId}','${ssMasters.ssMasterBl}')"/>
