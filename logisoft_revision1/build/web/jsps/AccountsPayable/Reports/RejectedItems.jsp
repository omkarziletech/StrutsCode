<%-- 
    Document   : RejectedItems
    Created on : Aug 17, 2010, 6:38:36 PM
                ...
                <table border="0" cellpadding="2" cellspacing="0" width="100%" class="tableBorderNew">
                    ...
                    <tr>
                        <td colspan="6" align="center">
                            <input type="button" class="buttonStyleNew" value="Clear" onclick="clearValues('showRejectedItems')">
                            <input type="button" class="buttonStyleNew" value="Print" onclick="printReport('printRejectedItems')">
                            <input type="button" class="buttonStyleNew" value="Export To Excel" onclick="exportToExcel('exportRejectedItemsToExcel')" style="width:100px">
                        </td>
                    </tr>
                </table>
            </div>
