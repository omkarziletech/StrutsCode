            ...
            <div class="scrolldisplaytable">
                <table width="100%" cellpadding="0" cellspacing="3" class="displaytagstyleNew" id="ssMasters" style="border: 1px solid white">
                    <thead>
                        ...
                        <tr>
                            <th><a href="javascript:doSort('bl.module_name','${orderBy}')"> Module Name </a></th>
                            <th><a href="javascript:doSort('bl.file_no','${orderBy}')"> File No </a></th>
                            <th><a href="javascript:doSort('bl.ssline_name','${orderBy}')"> SSL Name </a></th>
                            <th><a href="javascript:doSort('bl.ssline_no','${orderBy}')"> SSL No </a></th>
                            <th><a href="javascript:doSort('bl.ssline_name','${orderBy}')"> Destination Agent Name </a></th>
                            <th><a href="javascript:doSort('bl.ssline_no','${orderBy}')"> Destination Agent No </a></th>
                            <th><a href="javascript:doSort('bl.sail_date','${orderBy}')"> ETD </a></th>
                            <th><a href="javascript:doSort('bl.eta','${orderBy}')"> ETA </a></th>
                            <th><a href="javascript:doSort('bl.steam_ship_bl','${orderBy}')"> Prepaid/Collect </a></th>
                            <th>Action</th>
                        </tr>
                    </thead>
                    <tbody>
                            ...
                            <tr class="${zebra}">
                                ...
                                <td>
                                    <img alt="Convert to AP" title="Convert to AP"
                                         src="${path}/images/icons/forward.png" onclick="convertToAp('${ssMasters.fileNo}','SSMasters')"/>
