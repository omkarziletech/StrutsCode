...
<html> 
    <head>
        ...
        <script type="text/javascript" language="javascript">
            ...
            function yearDateValidation(date){
                var d = date.value.split("-");
                var enteredYear=d[2].substring(0,6);
		...
		document.inbondDetailsForm.submit();
            ...
            function openInbondDiv(){
                 ...
                 document.inbondDetailsForm.inbondPort.value="";
    ...
    <body class="whitebackgrnd" >
        ...
        <html:form action="/bookingInbondDetails" styleId="bookingInbondDetails" scope="request">
            ...
            <table width="100%" border="0" cellpadding="3" cellspacing="0"	id="records" >
             ...
             <div id="inbondDiv" style="display: none">
				...
				<html:optionsCollection name="inbondTypeList"/>
                        ...
                        <td>
                            <input Class="textlabelsBoldForTextBox" name="inbondPort" id="inbondPort"  size="18"/>
                        ...
                        <td>
                            <html:text styleClass="textlabelsBoldForTextBox" property="inbondDate"
                                       styleId="txtinbondCal" onblur="dateValidation(this)" onchange="yearDateValidation(this)" size="18" />
                        </td>
                    </tr>
                        ...
                        <div id="inbondDisplayTableId">
                            <table border="0" cellpadding="0" cellspacing="0" id="inbondDetailstable">
                                ...
                                <display:table name="${inbondDetailsList}" id="inbondTable"
                                               class="displaytagstyle"   pagesize="50">
                                    ...
                                    <fmt:formatDate pattern="dd-MMM-yyyy" var="date" value="${inbondTable.inbondDate}"/>
