...
List docReciept = null;
 ...
 String editPath=path+"/stuffexport.do";
 %>
...
<html:form action="/stuffexport" name="stuffexportform" type="com.gp.cong.logisoft.struts.containermangement.form.StuffExportForm"   scope="request" >  
...
<tr>
  <td width="261" height="24" class="headerbluelarge">Stuff Export </td>
  <td width="26" class="textlabels">Unit:</td>
  <td width="100" class="nonlabels"><%=unitNumber%></td>
  <td width="91" class="textlabels">Export Voyage:</td>
