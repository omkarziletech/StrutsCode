<%--
    Document   : copyBatch
    Created on : Aug 30, 2011, 2:22:40 AM
...
<table width="100%"
    ...
    <tbody>
        <tr>
            <td class="lightBoxHeader">Copy Batch - ${batchId}</td>
            <td>
    ...
    <table width="100%" cellpadding="3" cellspacing="3" border="0">
        ...
        <tr>
            <td colspan="2" align="center">
                <input type="button" value="New Batch" class="buttonStyleNew" onclick="copyToNewBatch()"/>
                <input type="button" value="Old Batch" class="buttonStyleNew" onclick="copyToOldBatch()"/>
            </td>
        </tr>
    </table>
</div>
