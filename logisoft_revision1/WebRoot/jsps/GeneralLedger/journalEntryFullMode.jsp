...
<c:set var="path" value="${pageContext.request.contextPath}"></c:set>
    ...
    <tr class="textlabelsBold">
        ...
        <td>
            <html:text property="glBatch.description" styleId="glBatchDescription"
                       styleClass="textlabelsBoldForTextBox" maxlength="40" style="text-transform:uppercase;"/>
        </td>
        <td>Status</td>
        <td>
    ...
    <tr class="textlabelsBold">
        <td colspan="3" align="right">
            ...
            <input type="button" value="Add" class="buttonStyleNew" onclick="addBatch()" tabindex="-1"/>
	...
	<td colspan="3">
		...
		<div class="float-left">
		    ...
		    <div class="float-left">
			<input type="file" name="importBatchFile" id="importBatchFile" tabindex="-1"/>
		    </div>
		    <div class="float-left" style="margin: 2px 0 0 2px">
			<input type="button" value="Import" class="buttonStyleNew" onclick="importBatch()" tabindex="-1"/>
		    </div>
		</div>
	    </c:if>
	</td>
...
<table width="100%" border="0" cellpadding="3" cellspacing="0" class="tableBorderNew">
	...
	<td colspan="3">
	    <c:if test="${canEdit}">
		<div class="float-left">
		    <html:hidden property="journalEntryFileName" styleId="journalEntryFileName"/>
		    <div class="float-left">
			<input type="file" name="importJournalEntryFile" id="importJournalEntryFile" tabindex="-1"/>
		    </div>
		    <div class="float-left" style="margin: 2px 0 0 2px">
			<input type="button" value="Import" class="buttonStyleNew" onclick="importJournalEntry()" tabindex="-1"/>
		    </div>
		</div>
	    </c:if>
	</td>
