...
<html>
  <head>
   ...
   <title>JSP for ConsigneeInformationForm form</title>
	...
	function selectcity()
    {
   		 if(document.consigneeInformationForm.notifyCountry.value=="0")
    {
    	alert("Please enter the country");
   	    return;
    }
    if(IsNumeric(document.consigneeInformationForm.taxExempt.value.replace(/ /g,''))==false)
   {
    	alert("Tax Exempt should be Numeric.");
  		document.consigneeInformationForm.taxExempt.value="";
    	document.consigneeInformationForm.taxExempt.focus();
   	  return;
   } 
   if(IsNumeric(document.consigneeInformationForm.maxDaysBetVisits.value.replace(/ /g,''))==false)
   {
    	alert("Max Days Between Visits should be Numeric.");
  		document.consigneeInformationForm.maxDaysBetVisits.value="";
    	document.consigneeInformationForm.maxDaysBetVisits.focus();
   	  return;
   } 
    	document.consigneeInformationForm.buttonValue.value="selectcity";
    	document.consigneeInformationForm.submit();
    }
    function selectstate()
    {
    if(document.consigneeInformationForm.notifyCity.value=="0")
    {
   ...
   if(IsNumeric(document.consigneeInformationForm.maxDaysBetVisits.value.replace(/ /g,''))==false)
   {
     ...
     document.consigneeInformationForm.buttonValue.value="selectstate";
    document.consigneeInformationForm.submit();
    }
	...
	<body class="whitebackgrnd" >
		<html:form action="/consigneeInformation" scope="request">
...
<tr class="style2">
  ...
  <tr class="style2">
     ...
     <tr class="style2">
      ...
      <tr class="style2">
      	...
      	<td><html:text property="zipCode" value="<%=consigneeInformation.getZipCode()%>" maxlength="10"/></td>
 ...
 <tr>
 			<td>
 						<table  width="800">
 										<tr>
 												<td height="12" width="800" class="headerbluesmall">&nbsp;&nbsp;<bean:message key="form.consigneeInformationForm.webInventory" /></td>
      							</tr>
 						</table>
 			</td>
 </tr>
 		...
 		<td>
	 		<table>
     				...
     				<tr class="style2">
     									...
     									<td valign="top"><html:text property="userName" value="<%=consigneeInformation.getUserName()%>"/></td>
     									<td valign="top"><html:password property="password" value="<%=consigneeInformation.getPassword()%>"/></td>
