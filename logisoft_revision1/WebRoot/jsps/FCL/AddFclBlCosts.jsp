...
<%    boolean importFlag = (null != request.getParameter("importFlag") && request.getParameter("importFlag").equalsIgnoreCase("I") ? true : false);
...
<html>
    <head>
        ...
        function addCostDetails(ev1, ev2, fileNo) {
            ...
            if (chargeCode.trim() === "ADVFF" || chargeCode.trim() === "PBA") {
             ...
             if (chargeCode.trim() === "ADVSHP") {
                if ('${importFlag}' === 'true' && parent.parent.document.getElementById('houseSHipper').value === "") {
                    ...
                    return false;
                } else if (parent.parent.document.getElementById('shipper').value === "") {
            ...
            document.fclBillLaddingform.buttonValue.value = "addBlCost";
        ...
        function updateCostDetails(ev1, ev2) {
            ...
            document.fclBillLaddingform.buttonValue.value = "updateBlCost";
            document.fclBillLaddingform.submit();
        }
        function fillInvoiceNumber() {
            ...
            if (null !== costcode && costcode === 'DEFER') {
                ...
                document.getElementById("accountName").value =parent.parent.document.getElementById("streamShipName").value;
                document.getElementById("accountNo").value=parent.parent.document.getElementById("sslinenumber").value;
                document.getElementById('accountNameCheck').value = document.getElementById('accountName').value;
                document.getElementById('accountName').readOnly = true;
                document.getElementById('accountName').tabIndex = -1;
                document.getElementById('accountName').className = "textlabelsBoldForTextBoxDisabledLook";
            } else {
                ...
                <td>
                    <table width="100%">
                        <tr class="textlabelsBold">
                            ...
                            <td>
                                <c:choose>
                                    <c:when test="${param.chargeCodeStatus =='' || fclBillLaddingform.costCode == 'FAECOMM' || fclBillLaddingform.costCode == 'DEFER'}">
                            ...
                            <tr class="textlabelsBold"> 
                                ...
                                <td valign="top">
                                <c:choose>
                                    <c:when test="${! empty fclBillLaddingform.costCode && (fclBillLaddingform.costCode == 'FAECOMM' || fclBillLaddingform.costCode == 'DEFER')}">
                        ...
                        <tr>
                            ...
                            <td align="center">
                                <c:choose>
                                    <c:when test="${param.button=='editBlCost'}">
