    ...
    <cong:table width="100%" style="margin:5px 0; float:left">
        <cong:tr>
            <cong:td styleClass="tableHeadingNew" colspan="4">
                <cong:div styleClass="floatLeft">Audit Remarks &nbsp;&nbsp;
                </cong:div>
            </cong:td>
        </cong:tr>
    </cong:table>
    <cong:table align="center" style="font-size: 14px" width="80%">
        ...
        <cong:tr><cong:td>
                <cong:table  border="0" width="100%">
                    ...
                    <cong:tr>
                        <cong:td>
                            <cong:textarea styleClass="refusedTextarea" id="remarks" name="remarks" value="${remarks}"></cong:textarea>
                        </cong:td>
                    </cong:tr>
                    <cong:tr>
...
<script>
    ...
    function updateVoyageRemarks(status,headerId,unitId){
        ...
        parent.document.getElementById("auditedRemarks").value = remarks.toString().toUpperCase();
        ...
        parent.document.getElementById("auditedRemarks").value = remarks;
