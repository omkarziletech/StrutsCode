...
<div style="width:100%; float:left;">
    <table class="tableHeadingNew" style="width:100%" align="center">
        <cong:tr>
            <cong:td align="center">
                Truck Pickup List
            </cong:td>
            <cong:td styleClass="floatLeft" width="8%">
                <span class="button-style1" onclick="savePickupCharge();">Save</span></cong:td>
        </cong:tr>
    </table>
    <table class="floatLeft" width="25%">
        <cong:tr>
    ...
    <table width="100%" class="dataTable">
        ...
        <c:if test="${empty lclSession.carrierList && lclQuotePickupInfoForm.moduleName eq 'Exports'}">
            <tbody><tr><td></td>
                    <td></td>
                    <td colspan="2">
...
<script type="text/javascript">
    function savePickupCharge() {
        ...
        if ($("input:radio[name='carrierRadio']:checked").is(':checked')) {
            ...
            showLoading();
            $.ajax({
                url: "lclQuotePickupInfo.do?methodName=addPickupChargeToAcct&fileNumberId=" + fileNumberId + "&scac=" + scac + "&pickupCharge=" + pickupCharge + "&fax=" + fax + "&contactName=" + contactName + "&phone1=" + phone1 + "&pickupHours=" + pickupHours + "&pickupReadyNote=" + pickupReadyNote + "&email1=" + email1 + "&spAcct=" + spAcct + "&pickupReadyDate=" + pickupReadyDate + "&fromZip=" + fromZip + "&toZip=" + toZip,
