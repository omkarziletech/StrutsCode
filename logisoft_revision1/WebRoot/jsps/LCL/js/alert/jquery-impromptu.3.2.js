...
(function($) {
    $.prompt = function(message, options) {
        ...
        msgbox += '<div class="'+ options.prefix +'" id="'+ options.prefix +'"><div class="'+ options.prefix +'container"><div id="'+ options.prefix +'states"></div>';
        //<div class="'+options.prefix +'close">X</div>-- alert X symbol removed
        msgbox += '</div></div></div>';
