...
String accountDetailsPath=path+"/jsps/Tradingpartnermaintainance/consignee.jsp";
String consigneeDetailsPath=path+"/jsps/Tradingpartnermaintainance/consigneeInformation.jsp";
