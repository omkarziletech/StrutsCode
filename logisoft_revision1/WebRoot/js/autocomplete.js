...
Autocompleter.DWR.prototype = Object.extend(new Autocompleter.Base(), {
    ...
    getUpdatedChoices: function() {
       // alert("this.getToken()"+this.getToken());
        this.populator(this, this.getToken());  // .substring(0,this.getToken().indexOf('<-->'))this is the populator specified in the constructor.
    },
                   ...
                   //  alert("foundPos-->"+foundPos);
                    while (foundPos != -1) {
                        if (foundPos == 0 && elem.length != entry.length) {
                          ...
                          //alert("entry-->"+entry);
                          //alert("Hi-->"+elem.toLowerCase().indexOf(entry.toLowerCase()));
