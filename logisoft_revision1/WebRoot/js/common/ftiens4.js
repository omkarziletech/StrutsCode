...
// ***************************************************************** 
function Folder(folderDescription, hreference,itemid,path) //constructor 
{ 
  //constant data 
...
{ 
  ...
  { 
    ...
    if (browserVersion > 0) 
      docW = docW + "onClick='javascript:clickOnFolder(\""+this.id+"\",\""+this.itemid+"\",\""+this.path+"\")'"
...
function clickOnFolder(folderId,itemid,reqpath) 
{ 
 ...
 redirect(itemid,reqpath);
} 

function redirect(itemid,reqpath)
{

//"<a href=\"/logisoft/jsps/admin/treemenu.jsp\" target=\"topframe\"></a>"
//location.href='/logisoft/jsps/admin/UserManagement.jsp ' ;

//if(self.location==top.location)self.location="/logisoft/jsps/admin/UserManagement.jsp";
//"<A href='/logisoft/jsps/admin/UserManagement.jsp ' target=\"topframe\"></A>"

parent.frames.tabframe.location.href=reqpath+"/jsps/Tab.jsp?folderId="+itemid;

 //parent.frames.maindataFrame.location.href(folderId.value)
 //parent.frames.maindataFrame.location.href(folderId.value)
...
function gFld(description,hreference,itemid,path) 
{ 
  
  folder = new Folder(description,hreference,itemid,path);
  return folder;
} 
