...
function CreateScrollHeader(content, scrollHorizontal, scrollVertical)
{
	...
	{	
		...
		tableRows=content.childNodes[0].rows.length;
		tableColumns=content.childNodes[0].childNodes[0].childNodes[0].childNodes.length;
		if(tableRows>6 && tableColumns > 10){
			divContent = content;
			...
			divContent.childNodes[0].childNodes[0].childNodes[0].style.position='relative';
		}
	}
}
